export default class PluginOverride {
    static override(pluginName, override) {
        PluginOverride.overrideClass(window.PluginManager.getPlugin(pluginName).get('class'), override);
    }
    static overrideClass(plugin, override) {
        if (plugin.__overrides === undefined) {
            plugin.__overrides = {};
            plugin.__overridesStack = {};
        }
        plugin.prototype['callParent'] = function (name, ...args) {
