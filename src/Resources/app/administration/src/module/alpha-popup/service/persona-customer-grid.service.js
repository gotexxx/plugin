...
export default class PersonaCustomerGridService {
    constructor(component, repoCustomers, repoPopupCustomers, context) {
        this.component = component;
        this.repoCustomers = repoCustomers;
        this.repoPopupCustomers = repoPopupCustomers;
    ...
    getColumns() {
        return [{
            property: 'fullName',
            dataIndex: 'fullName',
            label: this.component.$tc('alpha-popup.detail.main.preconditions.persona.customers.grid.headerName'),
            allowResize: false
        }, {
            property: 'customerNumber',
            dataIndex: 'customerNumber',
            label: this.component.$tc('alpha-popup.detail.main.preconditions.persona.customers.grid.headerCustomerNumber'),
            allowResize: false
        }];
    }
    ...
    async reloadCustomers() {
        ...
        await this.repoPopupCustomers.search(criteria, this.context).then((customers) => {
