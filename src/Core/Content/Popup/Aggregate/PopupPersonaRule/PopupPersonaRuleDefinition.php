...
namespace Alpha\Popup\Core\Content\Popup\Aggregate\PopupPersonaRule;
...
class PopupPersonaRuleDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'alpha_popup_persona_rule';

    /**
     * This class is used as m:n relation between popups and persona rules.
     * It gives the option to assign what rules may use this popup.
     */
