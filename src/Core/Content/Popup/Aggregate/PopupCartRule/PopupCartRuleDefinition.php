...
namespace Alpha\Popup\Core\Content\Popup\Aggregate\PopupCartRule;
...
class PopupCartRuleDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'alpha_popup_cart_rule';
